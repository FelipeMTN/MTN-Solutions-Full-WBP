...
export const Cta = () => {
  return (
    <Column fillWidth horizontal="center" borderBottom="neutral-alpha-medium" paddingX="l">
      ...
      <Row maxWidth="l" height="m" center paddingX="l" topRadius="xl" gap="24" s={{direction: "column"}} borderTop="neutral-alpha-medium" borderLeft="neutral-alpha-medium" borderRight="neutral-alpha-medium" overflow="hidden">
