...
import { Meta, Schema, AvatarGroup, Column, Heading, HeadingNav, Icon, Row, Text, Media, IconButton } from "@once-ui-system/core";
      ...
      <Row maxWidth={14} s={{hide: true}}/>
        <Row fillWidth horizontal="center">
          <Column as="section" maxWidth="s" gap="12">
            ...
            />
              <Text marginLeft="48" variant="body-default-xs" onBackground="neutral-weak">
                {post.metadata.publishedAt && formatDate(post.metadata.publishedAt)}
              </Text>
              <Row fillWidth gap="8">
              <Row paddingY="4">
                <IconButton data-border="rounded" href="/blog" variant="tertiary" size="l" icon="chevronLeft"/>
              </Row>
              <Heading variant="display-strong-s">
                {post.metadata.title}
              </Heading>
            </Row>
            <Row gap="16" vertical="center" marginLeft="48" marginBottom="20" marginTop="8">
